 ...
 * Модель news.
 */
class NewsModelNews extends JModelAdmin
{
	/**
	 ...
	 */
	public function getTable($type = 'News', $prefix = 'NewsTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		// Получаем форму.
		$form = $this->loadForm(
			$this->option . '.news', 'news', array('control' => 'jform', 'load_data' => $loadData)
		);
	...
	{
		return 'administrator/components/' . $this->option . '/models/forms/news.js';
	}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState($this->option . '.edit.news.data', array());
